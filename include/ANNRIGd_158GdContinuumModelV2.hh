 ...
 */
class ANNRIGd_158GdContinuumModelV2 : public ANNRIGd_Model {
  //------------------------------------------------------------------------------
 public:  // constructors and destructors
  ...
  //------------------------------------------------------------------------------
 public:  // operators
  ANNRIGd_158GdContinuumModelV2& operator=(const ANNRIGd_158GdContinuumModelV2& other);
...
inline ANNRIGd_158GdContinuumModelV2* ANNRIGd_158GdContinuumModelV2::Clone() const { return DoClone(); }

//______________________________________________________________________________
//! @copydoc ANNRIGd_Model::DpClone() const
inline ANNRIGd_158GdContinuumModelV2* ANNRIGd_158GdContinuumModelV2::DoClone() const {
